...
# Example: ERL_FLAGS='+S 4:4' mix run bench/partition_indexes.exs 128 512 2048 8192
...
defmodule Multigraph.Bench.PartitionIndexes do
...
Multigraph.Bench.PartitionIndexes.run(sizes)
